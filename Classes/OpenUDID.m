...
static NSString * const kOpenUDIDKey = @"GraphDogUDID";
static NSString * const kOpenUDIDSlotKey = @"GraphDogUDID_slot";
static NSString * const kOpenUDIDAppUIDKey = @"GraphDogUDID_appUID";
static NSString * const kOpenUDIDTSKey = @"GraphDogUDID_createdTS";
static NSString * const kOpenUDIDOOTSKey = @"GraphDogUDID_optOutTS";
static NSString * const kOpenUDIDDomain = @"net.GraphDog";
static NSString * const kOpenUDIDSlotPBPrefix = @"net.GraphDogUDID.slot.";
